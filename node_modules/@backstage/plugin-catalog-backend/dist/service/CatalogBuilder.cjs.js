...
var ModelProcessor = require('../processors/ModelProcessor.cjs.js');
...
class CatalogBuilder {
  ...
  async build() {
    ...
    const entitiesCatalog = new AuthorizedEntitiesCatalog.AuthorizedEntitiesCatalog(
      ...
      permissions,
      pluginPermissionNode.createConditionTransformer(
        permissionsRegistry.getPermissionRuleset(
          alpha.catalogEntityPermissionResourceRef
        )
      )
    );
    ...
    permissionsRegistry.addResourceType({
      ...
      getResources,
      permissions: [...alpha$1.catalogPermissions],
      rules: Object.values(index.permissionRules)
    });
  ...
  buildProcessors() {
    ...
    if (!this.env.modelHolder && !this.processors.some(
    ...
    if (this.env.modelHolder) {
      processors.push(new ModelProcessor.ModelProcessor(this.env.modelHolder));
    }
