...
const templateDefinitionSchema = v3$1.z.object({
  name: v3$1.z.string(),
  role: v3$1.z.enum(types.TEMPLATE_ROLES),
  description: v3$1.z.string().optional(),
  values: v3$1.z.record(v3$1.z.string()).optional()
}).strict();
