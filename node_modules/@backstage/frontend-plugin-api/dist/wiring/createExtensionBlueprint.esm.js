...
import { warnConfigSchemaPropDeprecation } from '../schema/createPortableSchema.esm.js';
  ...
  return {
    ...
    makeWithOverrides(args) {
      ...
      return createExtension({
        ...
        config: options.config?.schema || args.config?.schema ? {
          schema: {
            ...options.config?.schema,
            ...args.config?.schema
          }
        } : void 0,
        configSchema: options.configSchema || args.configSchema ? {
